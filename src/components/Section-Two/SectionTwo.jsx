...
const SectionTwo = () => {
  return (
    <section className="section sectionBG container mx-auto px-4  space-y-4 bg-[#F5EDDC]">
      <div>
      ...
      <div className=" md:w-[80%] mx-auto grid gap-6 items-center lg:grid-rows-2 lg:grid-cols-3 lg:gap-4 ">
        <div className=" text-center lg:text-left py-10 flex flex-col justify-center h-full space-y-12 lg:row-span-2 lg:col-span-2">
          ...
          <div className="space-y-3">
            ...
            <div className=" space-y-3 lg:pl-6">
              ...
              <p className="text-gray-600">(08/2022 - 12/2022)</p>
              <ol className="space-y-2 text-gray-600">
        ...
        <div className="text-left  font-medium shadow-tertiary   space-y-4    h-full flex flex-col justify-center items-start">
        ...
        <div className="text-center  lg:text-left    h-full flex flex-col justify-center items-start">
          <h4 className="py-4 leading-6 font-bold">
            Below is a list of libraries and frameworks that I have worked with.
          </h4>
          <h4 className="py-2">JS</h4>
          <p className="text-gray-600 py-1">- jQuery</p>
          <p className="text-gray-600 py-1">- ReactJS</p>
          <h4 className="py-2">CSS</h4>
          <p className="text-gray-600 py-1">- Bootstrap</p>
          <p className="text-gray-600 py-1">- TailwindCSS</p>
          <p className="text-gray-600 py-1">- SCSS</p>
        </div>
      </div>
    </section>
  );
